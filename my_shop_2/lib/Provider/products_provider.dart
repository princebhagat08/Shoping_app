...
class ProductsProvider with ChangeNotifier {
  ...
  Future<void> deleteProduct(String id) async {
    final url = Uri.parse(
        'https://flutter-shoping-application-default-rtdb.firebaseio.com/products/$id.json?auth=$authToken');
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
   ...
   final filterString = filterByUser ? 'orderBy="creatorId"&equalTo="$userId"': '' ;
    var url = Uri.parse(
        'https://flutter-shoping-application-default-rtdb.firebaseio.com/products.json?auth=$authToken&$filterString');
    try {
      ...
      // }
      url = Uri.parse(
          'https://flutter-shoping-application-default-rtdb.firebaseio.com/userFavourite/$userId.json?auth=$authToken');
  ...
  Future<void> addProduct(Product product) async {
    final url = Uri.parse(
        'https://flutter-shoping-application-default-rtdb.firebaseio.com/products.json?auth=$authToken');
    try {
